...
<body>
    <main class="auth-page">
        <section class="auth-shell" aria-label="Trang đăng ký JobFind">
            <div class="auth-panel">
                ...
                <form method="post" class="auth-form">
                    <div class="auth-field">
                        ...
                        <div class="auth-input">
                            ...
                            <input id="email" type="email" name="email" value="<?= htmlspecialchars($formValues['email']) ?>" placeholder="Email của bạn" autocomplete="email" required>
                        </div>
                    </div>

                    <div class="auth-field">
                        <div class="auth-field-label"><label for="name">Họ và tên</label></div>
                        <div class="auth-input">
                            <i class="fa-regular fa-user" aria-hidden="true"></i>
                            <input id="name" type="text" name="name" value="<?= htmlspecialchars($formValues['name']) ?>" placeholder="Ví dụ: Nguyễn Văn A" autocomplete="name">
                        </div>
                    </div>

                    <div class="auth-field">
                        <div class="auth-field-label"><label for="password">Mật khẩu</label></div>
                        <div class="auth-input">
                            <i class="fa-solid fa-shield" aria-hidden="true"></i>
                            <input id="password" type="password" name="password" class="js-password" placeholder="Tối thiểu 6 ký tự" autocomplete="new-password" required>
                    ...
                    <div class="auth-field">
                        <div class="auth-field-label"><label for="role">Bạn là</label></div>
                        <div class="auth-input">
                ...
                <p class="auth-signup">Đã có tài khoản? <a href="<?= BASE_URL ?>/account/login.php">Đăng nhập ngay</a></p>
